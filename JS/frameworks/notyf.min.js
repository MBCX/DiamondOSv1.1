var Notyf = function() {
    "use strict";
	const _nofitiAudio = new Audio('../Sounds/Notifications/NotificationIn.wav');
    var n, t, o = function() {
    ...
    var c = {
        ...
        p = (d.prototype.on = function(t, i) {
            ...
            e && "object" == typeof e && (p = this._createHTLMElement({
				...
				notificationControl(notificationStates.RETURN_TO_NORMAL_POSITION);
			...
			notificationControl(notificationStates.MOVE_BY_NOTIFICATION);
    ...
    return l.prototype.error = function(t) {
        ...
        e && setTimeout(function() {
			if (!document.querySelector('.virtual-desktop-view').classList.contains('show'))
			{
				notificationControl(notificationStates.RETURN_TO_NORMAL_POSITION);
			}
